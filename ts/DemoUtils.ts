module DemoUtils {
    ...
    export const colors = ['#1abc9c', '#2ecc71', '#3498db', '#9b59b6', '#34495e', '#16a085', '#27ae60', '#2980b9', '#8e44ad', '#2c3e50', '#f1c40f', '#e67e22', '#e74c3c', '#f39c12', '#d35400', '#c0392b'];
    export const countryExtensions = ["ad", "af", "ai", "al", "am", "ao", "aq", "ar", "as", "at", "au", "aw", "az", "bb", "bd", "be", "bf", "bg", "bh", "bi", "bj", "bm", "bo", "br", "bs", "bt", "bv", "bw", "by", "bz", "ca", "cg", "ch", "ck", "cl", "cm", "cn", "co", "co", "cr", "cu", "cv", "cx", "cy", "cz", "de", "dj", "dk", "dm", "dz", "ec", "ed", "ee", "eg", "eh", "er", "es"];
