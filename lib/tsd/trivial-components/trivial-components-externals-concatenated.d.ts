...
/// <reference path="../../../ts/customDefinitions.d.ts" />
/// <reference types="jquery" />
/// <reference types="jqueryui" />
...
export declare const DEFAULT_RENDERING_FUNCTIONS: {
    [key: string]: RenderingFunction<DefaultEntryStructure | DefaultCurrencyEntryStructure>;
};
export declare const DEFAULT_TEMPLATES: {
    defaultSpinnerTemplate: string;
    defaultNoEntriesTemplate: string;
};
export declare function wrapWithDefaultTagWrapper(entryHtml: string): string;
export declare function defaultListQueryFunctionFactory<E>(entries: E[], matchingOptions: MatchingOptions): QueryFunction<E>;
...
export declare function defaultTreeQueryFunctionFactory(topLevelEntries: any[], entryMatchingFunction: Function, childrenPropertyName: string, expandedPropertyName: string): (queryString: string, resultCallback: Function) => void;
export declare function customTreeQueryFunctionFactory(topLevelEntries: any[], childrenPropertyName: string, expandedPropertyName: string, customNodeMatchingFunction: (entry: any, queryString: string, nodeDepth: number) => boolean): (queryString: string, resultCallback: (entries: any[]) => void) => void;
...
export declare function minimallyScrollTo(element: JQuery | Element | string, target: JQuery | Element | string): void;
...
export declare type TrivialEventListener<EO> = (eventObject?: EO, eventSource?: any, originalEvent?: Event) => void;
export declare class TrivialEvent<EO> {
    private eventSource;
    private listeners;
...
export declare class TrivialListBox<E> implements TrivialComponent {
    private config;
    readonly onSelectedEntryChanged: TrivialEvent<E>;
    private $listBox;
    private $entryList;
...
export declare class TrivialTimeSuggestionEngine {
    constructor();
...
export declare class TrivialTreeComboBox<E> implements TrivialComponent {
...
export declare type HighlightOptions = MatchingOptions & {
